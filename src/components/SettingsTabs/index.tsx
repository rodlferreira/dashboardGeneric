    ...
    return (
        <Tabs.Root value={currentTab} onValueChange={setCurrentTab}>
            <ScrollArea.Root className="w-full" type="scroll">
                ...
                <Tabs.List className='mt-6 flex w-full items-center gap-4 border-b border-zinc-300 dark:border-zinc-700'>
                ...
                <ScrollAreaScrollbar className="flex h-0.5 translate-y -1.5 touch-none select-none flex-col bg-zinc-100" orientation="horizontal">
