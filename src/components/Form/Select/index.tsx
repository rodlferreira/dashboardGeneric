        ...
        <SelectPrimitive.Root {...props}>
            <SelectPrimitive.Trigger
                ...
                <SelectPrimitive.Icon>
                    <CaretDown className="h-5 w-5 text-zinc-500" />
                </SelectPrimitive.Icon>
            </SelectPrimitive.Trigger>
            <SelectPrimitive.Portal>
                <SelectPrimitive.Content
                    ...
                    sideOffset={8}
                    position="popper"
                    className="z-10 rounded-lg border border-zinc-200 bg-white w-[--radix-select-trigger-width] overflow-hidden shadow-sm dark:bg-zinc-800 dark:border-zinc-700">
