...
export function Sidebar() {
    return (
        <Collpasible.Root className=" border-b border-zinc-200 p-4  data-[state=open]:bottom-0  lg:data-[state=closed]:bottom-0 flex flex-col gap-6 fixed left-0 top-0 right-0 z-20 bg-white lg:right-auto lg:w-80 lg:border-r lg:px-5 lg:py-8 lg:relative">
